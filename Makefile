# This Makefile is for the ParseCron extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/ParseCron.pm]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/ParseCron.pm]
#     clean => { FILES=>q[ParseCron-*] }
...
TO_INST_PM = lib/ParseCron.pm \
	lib/pc.pl

PM_TO_BLIB = lib/ParseCron.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/ParseCron.pm $(INST_MAN3DIR)/ParseCron.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''describe a cron job in human-readable form '\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: ParseCron' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "describe a cron job in human-readable form ",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "ParseCron",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>describe a cron job in human-readable form </ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/ParseCron.pm blib/lib/ParseCron.pm \
	  lib/pc.pl blib/lib/pc.pl 
